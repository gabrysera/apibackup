...
class CoopSpider:
    ...
    "pile", "lampadine", "giardinaggio", "pellet", "auto","bio","pasta","senza glutine","vegan","kinder","barilla","pomodoro","pesto","arancia","fior","bene si","vivi verde"]
    ...
    def crawl(cls, category):
        ...
        if len(coopProducts) < 2:
            print("found only" + str(len(coopProducts)) + "in category: " + category)
        return coopProducts